...
## Linux implementation breakdown
Native Linux delivery is tracked in #15. Windows and additional STT providers remain separate future work in this issue. RustDesk remote delivery remains in #13.
