## Outcome
Control hold-to-dictate session controller and Escape cancellation.
...
## Acceptance criteria
- [ ] On macOS, holding Control for 350 ms starts exactly one session and release requests finalization; repeated flags do not duplicate work. Quick taps preserve normal Control behavior.
- [ ] Control combined with another modifier does not start dictation; Fn remains available to Wispr Flow. Esc cancels capture and pending insertion, including during finalization.
